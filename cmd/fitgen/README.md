...
[fit](https://github.com/kalyan02/fit). It takes as input the official FIT profile
specification workbook and outputs Go type, message and profile definitions.

Consult the [Wiki](https://github.com/kalyan02/fit/wiki/Profile-Generation)
...
[fitgen](https://github.com/kalyan02/fit/tree/master/cmd/fitgen).  Every field
